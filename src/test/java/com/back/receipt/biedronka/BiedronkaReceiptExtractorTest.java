...
class BiedronkaReceiptExtractorTest {
    ...
    public void extract() throws IOException, MyResourceNotFoundException {
        ...
        //When
        Receipt returnReceipt = biedronkaReceiptExtractor.extract(googleResponse);

        System.out.println(returnReceipt.getProductList());
        System.out.println(returnReceipt.getFullPrice());
        System.out.println(returnReceipt.getDate());
        System.out.println(returnReceipt.getAddress());


        //Then
        Assert.assertEquals("Sklep 6127 ul. Konstruktorska 10c, 02-673 Warszawa", returnReceipt.getAddress());
        Assert.assertEquals("2019-09-19 13:15", returnReceipt.getDate());
        Assert.assertEquals(46.41, returnReceipt.getFullPrice(), 0.01);
        Assert.assertEquals(exceptedProductList, returnReceipt.getProductList());
